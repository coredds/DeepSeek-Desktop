...
#   ./scripts/release-win.sh --tag v0.1.1 --channel stable
#
...
collect "Windows exe" "dist/DeepSeek-Desktop-*-win-*.exe"
collect "Windows blockmap" "dist/DeepSeek-Desktop-*-win-*.exe.blockmap"
