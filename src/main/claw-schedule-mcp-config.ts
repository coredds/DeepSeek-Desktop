...
const CLAW_SCHEDULE_MCP_MARKER_START = '# DeepSeek Desktop plugin:mcp:claw-schedule START'
const CLAW_SCHEDULE_MCP_MARKER_END = '# DeepSeek Desktop plugin:mcp:claw-schedule END'
