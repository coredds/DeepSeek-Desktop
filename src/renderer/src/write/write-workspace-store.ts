...
const WRITE_PREVIEW_MODE_KEY = 'deepseekdesktop.write.preview-mode'
const WRITE_ASSISTANT_OPEN_KEY = 'deepseekdesktop.write.assistant-open'
const WRITE_ASSISTANT_MODEL_KEY = 'deepseekdesktop.write.assistant-model'
...
function activeFileStorageKey(workspaceRoot: string): string {
  return `deepseekdesktop.write.active-file:${normalizePath(workspaceRoot)}`
}
