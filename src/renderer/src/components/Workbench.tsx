...
const LEFT_PANEL_WIDTH_KEY = 'deepseekdesktop.layout.leftSidebarWidth'
const LEFT_PANEL_COLLAPSED_KEY = 'deepseekdesktop.layout.leftSidebarCollapsed'
const RIGHT_PANEL_WIDTH_KEY = 'deepseekdesktop.layout.rightInspectorWidth'
const RIGHT_PANEL_MODE_KEY = 'deepseekdesktop.layout.rightPanelMode'
const BOTTOM_PANEL_HEIGHT_KEY = 'deepseekdesktop.layout.bottomTerminalHeight'
