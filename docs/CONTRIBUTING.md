...
For DeepSeek Desktop, taste means clear workflows, restrained interfaces, humane copy, and behavior that feels obvious after one use. Strong contributions show judgment, not just implementation.
...
A well-structured PR for DeepSeek Desktop is focused and self-contained. It typically:
...
- `docs/DEVELOPMENT.md` for workflow/process updates
...
- DeepSeek Desktop version (from Settings or the About dialog)
...
By contributing to DeepSeek Desktop, you agree that your contributions will be licensed under the [MIT License](../LICENSE).
